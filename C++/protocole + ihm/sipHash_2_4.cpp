...
/* 
 * File:   sipHash_2_4.cpp
 * Author: jeanloicm
 * 
 * Created on March 1, 2017, 3:33 PM
 */
...
unsigned const char v0_init[8] = {0x73, 0x6f, 0x6d, 0x65, 0x70, 0x73, 0x65, 0x75};
unsigned const char v1_init[8] = {0x64, 0x6f, 0x72, 0x61, 0x6e, 0x64, 0x6f, 0x6d};
unsigned const char v2_init[8] = {0x6c, 0x79, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61};
unsigned const char v3_init[8] = {0x74, 0x65, 0x64, 0x62, 0x79, 0x74, 0x65, 0x73};
